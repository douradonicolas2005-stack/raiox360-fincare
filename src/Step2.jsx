  ...
  return (
    <div className="animate-fade-in-up">
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl md:text-[28px] font-bold text-white leading-tight mb-3">
          Quase la. Precisamos dos seus dados
        </h1>
        <p className="text-sm text-white/60 max-w-md mx-auto leading-relaxed">
          Seu Raio-X Patrimonial sera gerado de forma <span className="font-semibold text-white/80">100% confidencial</span>. Precisamos apenas para enviar o relatorio e agendar sua analise.
        </p>
      </div>
      ...
      <div className="space-y-5">
        ...
        <div className="bg-white rounded-2xl p-5 md:p-6 shadow-[0_2px_16px_rgba(0,0,0,0.08)]">
          <h3 className="text-xs font-semibold tracking-[0.15em] uppercase text-[#00A651] mb-5">
            Dados pessoais
          </h3>

          <div className="space-y-4">
            <div>
              <label className="text-xs text-[#1A2E23]/50 mb-1.5 block">Nome completo</label>
              <input
                type="text"
                ...
                className={`w-full px-4 py-3 bg-[#F8FAF9] border rounded-xl text-sm text-[#1A2E23] focus:outline-none transition-colors ${
                  errors.nome && touched.nome
                    ? 'border-[#DC3545]/50 focus:border-[#DC3545]'
                    : 'border-[#E0EDE4] focus:border-[#00A651]'
                }`}
              />
              {errors.nome && touched.nome && (
            ...
            <div>
              <label className="text-xs text-[#1A2E23]/50 mb-1.5 block">E-mail</label>
              <input
                type="email"
            ...
            <div>
              <label className="text-xs text-[#1A2E23]/50 mb-1.5 block">WhatsApp</label>
              <input
                type="tel"
              ...
              <p className="text-[10px] text-[#1A2E23]/30 mt-1">
        ...
        <div className="bg-white rounded-2xl p-5 md:p-6 shadow-[0_2px_16px_rgba(0,0,0,0.08)]">
          ...
          <div className="space-y-4">
            <label className="flex items-start gap-3 cursor-pointer group">
                ...
                <div className={`w-5 h-5 rounded border-2 flex items-center justify-center transition-all ${
                  data.consentContato
                    ...
                    : errors.consentContato
                      ? 'border-[#DC3545]/50 bg-[#F8FAF9]'
                      : 'border-[#C8E6CF] bg-[#F8FAF9] group-hover:border-[#00A651]/40'
                }`}>
                  {data.consentContato && (
              ...
              <span className="text-xs text-[#1A2E23]/55 leading-relaxed">
                <span className="text-[#1A2E23]/75 font-medium">Obrigatorio:</span> Autorizo o contato da <span className="text-[#00A651] font-medium">Fincare</span> via WhatsApp e/ou e-mail para envio do Raio-X Patrimonial e agendamento de analise patrimonial confidencial.
              </span>
            </label>
            ...
            <label className="flex items-start gap-3 cursor-pointer group">
              ...
              <span className="text-xs text-[#1A2E23]/55 leading-relaxed">
                <span className="text-[#1A2E23]/75 font-medium">Obrigatorio:</span> Li e concordo com a{' '}
                <span className="text-[#00A651] underline underline-offset-2">Politica de Privacidade</span> da Fincare. Meus dados serao tratados conforme a LGPD (Lei 13.709/2018) e utilizados exclusivamente para a prestacao dos servicos de engenharia patrimonial.
              </span>
            </label>
            ...
            <label className="flex items-start gap-3 cursor-pointer group">
              ...
              <span className="text-xs text-[#1A2E23]/55 leading-relaxed">
                <span className="text-[#1A2E23]/40">Opcional:</span> Desejo receber conteudos exclusivos da Fincare sobre investimentos, planejamento patrimonial e oportunidades de mercado.
              </span>
            </label>
          </div>

          <div className="mt-5 pt-4 border-t border-[#E0EDE4]">
            <p className="text-[10px] text-[#1A2E23]/30 leading-relaxed">
